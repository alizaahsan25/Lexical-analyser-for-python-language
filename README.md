...
Download all the files from this project and save them in a specific folder. Open that folder is vs code. Open terminal in that folder and bash "**pyhton analyze.py**" and then it will ask the file name that has teh souce code to be analyzed. Enter "**test.py**" and laxical analysis will create tokens of the source code written in test.py .
